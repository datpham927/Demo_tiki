...
var loginAndRegister__modal=document.querySelector(".loginAndRegister__modal")
var loginAndRegister__close=document.querySelector(".loginAndRegister__close");
...
var container1_max=document.getElementsByClassName("webimg1__list--img")[0].clientWidth;
...
var container1_imgSize=document.getElementsByClassName("webimg1__left")[0].clientWidth;
var Arr_quantity1=document.querySelectorAll(".webimg1__left .quantity_img li")
...
function convert_Img1(index){
        ...
        document.getElementById("container1_convert").style.transform ="translateX("+container1_Margin+"px)";
}
...
//  ----------- convert2 ------------
var Size_container2=document.getElementsByClassName("container2__index")[0].clientWidth;
var Max_container2=document.getElementsByClassName("container2__list")[0].clientWidth;

var Right_icon2=document.querySelector(".container2__index .icon2__bgr--right");
var Left_icon2=document.querySelector(".container2__index .icon2__bgr--left ")
var number2=0;
...
autoFlash()
  ...
  var size__convertRight=document.getElementsByClassName("webimg__right2")[0].clientWidth;
  var number2_right=0;
  var quantity2=0;
  var Array_ConvertRight2=document.querySelectorAll(".webimg__right2 .quantity_img .quantity-item")
  var length_ConvertRight2=document.querySelectorAll(".webimg__right2 .quantity_img .quantity-item").length;
  ...
  function ConvertRight2(index){
         ...
         document.querySelector(".webimg__right2--list").style.transform="translateX(-"+ number2_right+ "px)";
  }
...
var m_size__convertRight=document.getElementsByClassName("m_webimg__right2")[0].clientWidth;
var m_number2_right=0;
var m_quantity2=0;
var m_Array_ConvertRight2=document.querySelectorAll(".m_webimg__right2 .quantity_img .quantity-item")
var m_length_ConvertRight2=document.querySelectorAll(".webimg__right2 .quantity_img .quantity-item").length;
...
function m_ConvertRight2(index){
       ...
       document.querySelector(".m_webimg__right2--list").style.transform="translateX(-"+ m_number2_right+ "px)";
}
...
var Array_quantity6=document.querySelectorAll(".container6__body .quantity_img .container6__quantity")
...
var max_webImg6=document.getElementsByClassName("container6__body--img")[0].clientWidth;
var iconRight_webImg6=document.querySelector(".container6__body .icon__right")
var iconLeft_webImg6=document.querySelector(".container6__body .icon__left")
var size_webImg6=document.getElementsByClassName("container6__body")[0].clientWidth;
...
function marginLeft_webImg6(index){
          ...
          document.getElementById("container6__convertIMg").style.marginLeft="-" + marginLeft6+"px"
}
...
// --------- container6 ----------
var max_container6=document.getElementsByClassName("webimg6__list")[0].clientWidth;
var size_container6=document.getElementsByClassName("webimg6")[0].clientWidth;
var marginLeft_container6=0;
var iconRight_container6=document.querySelector(".webimg6 .webimg6_iconRight")
...
function convert_container6(index){
     ...
     document.querySelector(".webimg6__list").style.marginLeft="-"+marginLeft_container6+"px";
}
...
var max_mHot=document.getElementsByClassName("m_hot-left--img")[0].clientWidth-size_mHot;
...
function convertRight__mHot(index){
    ...
    document.getElementById("m_hot-convert").style.transform="transLateX(-"+wight_mHot+"px)"

}
var title_mHot=[" Deal Du Lịch Hấp Dẫn - Giảm Sốc Đón Hè",
...
function auto_background(){
    number++;
     ...
     if(number>1){
      ...
      setTimeout("auto_background()",100)
